...
function data_saveRoutineBegin(snapshot) {
      return async function () {
        ...
        let expNameSafe = String(psychoJS._experiment._experimentName || expName || "AXCPT_reactive")
